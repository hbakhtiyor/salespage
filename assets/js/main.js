...
$(function() { 
	...
	offerForm.validate({
		submitHandler: function(form) {
			...
			$.post('https://script.google.com/macros/s/AKfycbyQ6lBDqHBB19c1PAgv8xKO9Wv7wewc1A61gJ6--1zxt-TXry_u/exec', formData, function(data) {
				// Hide error message and form
				errorContainer.hide();
				$('.fields').hide();
				// Display success message
				successContainer.show().append("Thanks for contacting us!");
			}).always(function() { 
